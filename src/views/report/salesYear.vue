  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="商品编号" min-width="120" align="center" sortable>
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="商品货号" min-width="160" align="center" sortable>
          <template slot-scope="scope">{{scope.row.createTime | formatTime}}</template>
        </el-table-column>
        <el-table-column label="商品名称" align="center" min-width="150" sortable>
          <template slot-scope="scope">{{scope.row.memberUsername}}</template>
        </el-table-column>
        <el-table-column label="供货价" min-width="180" align="center" sortable>
          <template slot-scope="scope">{{scope.row.handleTime | formatTime}}</template>
        </el-table-column>
        <el-table-column label="销售量" min-width="180" align="center" sortable>
          <template slot-scope="scope">{{scope.row.handleTime | formatTime}}</template>
        </el-table-column>
        <el-table-column label="销售总金额" min-width="180" align="center" sortable>
          <template slot-scope="scope">{{scope.row.handleTime | formatTime}}</template>
        </el-table-column>
